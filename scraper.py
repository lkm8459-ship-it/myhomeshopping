...
def get_category(title):
    ...
    # 3. 의류(Fashion)
    fashion_brands = ['나이키', '아디다스', '푸마', '뉴발란스', '뉴발', '언더아머', '휠라', '노스페이스', '몽클레르', '파타고니아', '아크테릭스', '아식스', '살로몬', '반스', '칼하트']
    fashion_keywords = ['티셔츠', '셔츠', '니트', '맨투맨', '후드', '원피스', '스커트', '바지', '슬랙스', '청바지', '코트', '패딩', '자켓', '속옷', '양말', '레깅스', '운동화', '구두', '샌들', '슬리퍼', '가방', '모자', '안경', '선글라스', '액세서리', '쥬얼리', '시계', '옷', '신발', '잡화', '언더웨어', '스니커즈', '조거', '반팔', '바람막이', '팬티', '브라', '벨트', '지갑', '의류', '패션']
